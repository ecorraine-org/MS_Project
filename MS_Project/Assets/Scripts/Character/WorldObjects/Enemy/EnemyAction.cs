...
public abstract class EnemyAction : MonoBehaviour
{
    ...
    protected WorldObjectStateHandler stateHandler;
    ...
    {
        enemy.GenerateOnomatopoeia(enemy.gameObject, enemy.Status.StatusData.onomatoAttack);
    }

    protected void GenerateWalkOnomatopoeia()
    {
        enemy.GenerateOnomatopoeia(enemy.gameObject, enemy.Status.StatusData.onomatoWalk);
    }
